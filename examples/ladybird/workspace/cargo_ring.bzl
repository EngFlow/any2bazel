...
# Meta/emit_cargo_bazel.py parses out of import_rust_crate() and
# build_rust_binary() in CMake, so a feature or header list cannot drift from
# the reference build without the emitter's --report saying so.
...
def cargo_ring():
    ...
    cargo_crate(
        ...
        ffi_bare_include = CARGO_CRATE_SPECS['libgfx_rust']["ffi_bare_include"],
    ...
    cargo_crate(
        ...
        ffi_bare_include = CARGO_CRATE_SPECS['libjs_rust']["ffi_bare_include"],
    ...
    cargo_crate(
        ...
        ffi_bare_include = CARGO_CRATE_SPECS['libregex_rust']["ffi_bare_include"],
    ...
    cargo_bare_include(
        name = 'libregex_rust_bare_include',
        crate = ':libregex_rust',
    )
    ...
    cargo_crate(
        ...
        ffi_bare_include = CARGO_CRATE_SPECS['libtextcodec_rust']["ffi_bare_include"],
    ...
    cargo_bare_include(
        name = 'libtextcodec_rust_bare_include',
        crate = ':libtextcodec_rust',
    )
    ...
    cargo_crate(
        ...
        ffi_bare_include = CARGO_CRATE_SPECS['libunicode_rust']["ffi_bare_include"],
    ...
    cargo_crate(
        ...
        ffi_bare_include = CARGO_CRATE_SPECS['liburl_rust']["ffi_bare_include"],
    ...
    cargo_crate(
        ...
        ffi_bare_include = CARGO_CRATE_SPECS['libweb_content_blocker_rust']["ffi_bare_include"],
    ...
    cargo_crate(
        ...
        ffi_bare_include = CARGO_CRATE_SPECS['libweb_rust']["ffi_bare_include"],
    ...
    # The BINARY crates: cargo `--bin` targets, declared in CMake with
    # build_rust_binary() rather than import_rust_crate(). Two of them, and
    ...
    cargo_binary(
        name = 'cranelift-compiler',
        bin = 'cranelift-compiler',
        crate = 'libwasm_cranelift',
        crates = CARGO_CRATE_FILES,
        manifest = 'Libraries/LibWasm/Rust/Cargo.toml',
        # This binary crate's build script runs cbindgen too, so the
        # header is a DECLARED output -- Bazel deletes what nothing
        # declares, and LibWasm includes this one bare.
        ffi_headers = ['CraneliftFFI.h'],
        ffi_prefix = 'LibWasm',
        ...
        srcs = crate_srcs + ['Libraries/LibWasm/Opcode.h'],
        sysroot = ":rust_sysroot",
    )

    # The consumable target, IDENTICAL in shape to a staticlib crate's:
    # this crate's generated header to include. There is no archive to
    # link -- what C++ consumes from a binary crate is the EXECUTABLE,
    # spawned at run time -- so cargo_lib yields a headers-only CcInfo.
    cargo_lib(
        name = 'libwasm_cranelift_lib',
